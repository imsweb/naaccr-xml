...
C:\jdk\jdk-17.0.4\bin\jlink --module-path C:\jdk\jdk-17.0.4\jmods --add-modules java.desktop,java.sql,java.xml,jdk.unsupported,jdk.accessibility --output jre-17 --no-header-files --no-man-pages --strip-debug --compress=2
