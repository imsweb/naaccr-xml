...
C:\jdk\jdk-11.0.2\bin\jlink --module-path C:\Users\Fabian\dev\jdk\jdk-11.0.2\jmods --add-modules java.desktop,java.sql,java.xml,jdk.unsupported --output jre-11.0.2 --no-header-files --no-man-pages --strip-debug --compress=2
