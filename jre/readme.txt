...
C:\jdk\jdk-11.0.7\bin\jlink --module-path C:\Users\Fabian\dev\jdk\jdk-11.0.7\jmods --add-modules java.desktop,java.sql,java.xml,jdk.unsupported --output jre-11 --no-header-files --no-man-pages --strip-debug --compress=2
