...
C:\jdk\jdk-11.0.9\bin\jlink --module-path C:\Users\Fabian\dev\jdk\jdk-11.0.9\jmods --add-modules java.desktop,java.sql,java.xml,jdk.unsupported,jdk.accessibility --output jre-11 --no-header-files --no-man-pages --strip-debug --compress=2
