...
This library provides support for the NAACCR XML format. It implements version 1.4 of [the specifications](https://www.naaccr.org/xml-data-exchange-standard/) but still supports prior versions.
